...
<p style="text-indent:2em">为此，隆重推荐用Sketch插件————Measure！！！从此妈妈再也不用担心我罗里吧嗦的繁琐切图问题了~</p>
...
<p>另外，Sketch3.4版本后，已支持自带插件管理工具，Sketch Toolbox基本可以退休了<img src="/images/sketch/21.png" style="width:10%"/>
